...
public class BluestoneBlock extends BluestoneBlockBase {
	...
	public BluestoneBlock(String name, Material material, Item toDrop) {
		this(name, material, toDrop, 1, 1);
	}

	public BluestoneBlock(String name, Material material, Item toDrop, int dropAmount) {
		this(name, material, toDrop, dropAmount, dropAmount);
	}

	public BluestoneBlock(String name, Material material, Item itemDrop,int minDrop,int maxDrop) {
		super(name, material);
